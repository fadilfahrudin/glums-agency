...
const HeaderWP = () => {
    ...
    return (
        <motion.section ref={ref} className='section-text__wp'>
            <div className='welcome-text'>
                <motion.div className='text-item' >
                    <motion.div className="text-pointer" initial="inActive" variants={toDown} animate="active" custom={1} > BEYOND SOLUTION </motion.div>
                </motion.div>
            ...
            <div className='welcome-text'>
                ...
                <div className='text-item' >
                    <motion.div className="text-pointer" initial="inActive" variants={toUp} animate="active" custom={2} > BEYOND EXPECTATION </motion.div>
                </div>
                <motion.div initial="inActive" variants={other} animate="active" custom={5} className='text-secondLine'>Glums was founded with a vision to empower businesses of all sizes to thrive in the ever-evolving digital world.</motion.div>
            </div>
